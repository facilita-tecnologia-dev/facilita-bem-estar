        ...
        <div class="flex-1 overflow-auto p-4 md:p-8 flex flex-col items-center justify-start gap-6">
            ...
            <div class="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
                <a 
                    ...
                    " 
                    class="relative overflow-hidden transition border border-white rounded-md py-6 lg:py-16 px-4 flex flex-col gap-2 lg:gap-8 items-center"
                >
                ...
                <a 
                    ...
                    style="
                        background: linear-gradient(0deg , #ffffff25 0%, #ffffff25 100%);
                    " 
                    class="relative overflow-hidden transition border border-white rounded-md py-6 lg:py-16 px-4 flex flex-col gap-2 items-center"
                >
