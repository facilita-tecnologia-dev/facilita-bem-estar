<x-layouts.app>
        ...
        <div class="bg-white rounded-md w-full max-w-screen-md min-h-2/4 max-h-3/4 shadow-md p-10 flex flex-col items-center justify-center gap-8">
            ...
            <x-test.questions-form action="{{ route('test.submit', 'pressao-no-trabalho')}}" id="test-form" post>
            ...
            <div class="flex items-center justify-between w-full">
                ...
                <x-actions.anchor href="{{ route('test', 'depressao') }}" variant="outline" color="danger">
        ...
        <x-footer>
            Baseado na ISO 45003:2021 e Copenhagen Psychosocial Questionnaire (COPSOQ) [Kristensen et al., 2005]
        </x-footer>
