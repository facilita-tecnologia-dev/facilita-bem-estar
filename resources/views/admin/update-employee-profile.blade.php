    ...
    <div class="w-screen h-screen flex overflow-hidden pt-16 md:pt-0">
        ...
        <div class="flex-1 overflow-auto p-4 md:p-8 flex flex-col items-start justify-start gap-6">
            ...
            <div class="w-full bg-gray-100 rounded-md shadow-md p-4 md:p-8 space-y-6">
                <x-form action="{{ route('employee-profile.update', $employee) }}" id="form-update-company-profile" post class="w-full grid grid-cols-1 md:grid-cols-2 gap-4" enctype="multipart/form-data">
                ...
                <div class="w-full flex flex-col md:flex-row justify-between gap-2">
                    <x-action href="{{ route('employee-profile', $employee) }}">Cancelar</x-action>
