<x-layouts.app>
    <div class="w-screen h-screen flex overflow-hidden pt-16 md:pt-0">
        ...
        <div class="flex-1 overflow-auto p-4 md:p-8 flex flex-col items-start justify-start gap-6">
            ...
            <div class="relative w-fit bg-gray-100/60 rounded p-1 shadow-inner grid grid-cols-3 gap-2">
                <div data-role="toggle-bg" class="absolute w-[calc(33%-4px)] h-9 bg-gray-200 shadow-sm rounded-md left-1 top-1 transition-all"></div>
                ...
                <button data-role="toggle-collection-tab" id="company-demographic-metrics" class="relative w-full px-2 h-9 rounded-md whitespace-nowrap">Demografia</button>
            </div>

            <div id="company-demographic-metrics-tab" data-role="collection-tab" class="contents">
                <p>demografia</p>
            </div>
                                    ...
                                    <div class="w-full">
                                        <p class="text-sm">{{ $metric->metricType->display_name }}</p>
                                            @if($metric->value != 'null')
                                                ...
                                                <div class="bar h-6 w-0 transition-all duration-700 bg-[#64B5F6]"></div>
