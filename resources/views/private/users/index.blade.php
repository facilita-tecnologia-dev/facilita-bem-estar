                    ...
                    <div class="space-y-2" data-role="tbody">
                        @foreach ($users as $user)
                            <a
                                ...
                                <span data-role="td" class="hidden lg:block">{{ $user->birth_date ? Carbon\Carbon::create($user->birth_date)->age . ' anos' : 'Não cadastrado' }}</span>
                                <span data-role="td" class="hidden lg:block">{{ $user->department ?? 'Não cadastrado' }}</span>
                                <span data-role="td" class="truncate">{{ $user->occupation ?? 'Não cadastrado' }}</span>
                            </a>
                        @endforeach
                    </div>
                </div>
