...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('build/assets/app-DPAB4qkM.css') }}">
...
<body class="bg-gray-100">
    ...
    <header class="relative max-w-[1440px] mx-auto flex flew-row justify-between items-center p-5">
        ...
        <div class="flex items-center gap-2">
            ...
            <a href="{{ route('auth.cadastro') }}" class="text-base font-medium bg-gray-100 text-gray-800 px-4 tracking-wider  py-1.5 rounded-md flex items-center gap-2">
